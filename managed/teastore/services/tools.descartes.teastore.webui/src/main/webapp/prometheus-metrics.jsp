<%@ page import="net.bull.javamelody.internal.model.CounterRequestContext"%><%@ taglib uri="javamelody-prometheus" prefix="prometheus" %>
<%@ page session="false"%>
...
<%-- https://github.com/javamelody/javamelody/wiki/UserGuideAdvanced#custom-reports --%>
<%-- Accurate http request https://dzone.com/articles/a-step-by-step-guide-to-tomcat-performance-monitor --%>