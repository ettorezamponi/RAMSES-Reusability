package ramses.monitor.domain;

import ramses.knowledge.domain.Modules;
import ramses.monitor.externalinterfaces.KnowledgeClient;
import ramses.knowledge.domain.metrics.InstanceMetricsSnapshot;
import ramses.monitor.externalinterfaces.ProbeClient;
import ramses.monitor.externalinterfaces.AnalyseClient;
...
public class MonitorService {
    ...
    private int schedulingPeriod = 10000; // monitor scheduling period [ms]
