...
index_split = np.searchsorted(time2, 6.033)
...
punti_intersezione = [(5.129, 200), (7.170, 200)]#, (8.03, 0.95), (8.97, 0.95)]
...
plt.axvline(x=6.033, color='gray', linestyle='--', label='Adaptation point', linewidth=1)
