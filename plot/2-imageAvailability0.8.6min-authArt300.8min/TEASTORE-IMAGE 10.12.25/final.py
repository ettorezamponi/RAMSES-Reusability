...
index_split = np.searchsorted(time2, 4.083)
...
punti_intersezione = [(3.05, 0.95), (6.970, 0.95)]#, (8.03, 0.95), (8.97, 0.95)]
...
plt.axvline(x=4.083, color='gray', linestyle='--', label='Adaptation point', linewidth=1)
