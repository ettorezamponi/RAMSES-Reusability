...
index_split = np.searchsorted(time2, 10.85)
...
punti_intersezione = [(4.626, 0.95), (5.331, 0.95), (6.405, 0.95), (8.383, 0.95)]
...
plt.axvline(x=10.85, color='gray', linestyle='--', label='Adaptation point', linewidth=1)
