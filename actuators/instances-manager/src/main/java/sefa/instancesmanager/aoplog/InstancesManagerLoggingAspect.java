package sefa.instancesmanager.aoplog;
...
public class InstancesManagerLoggingAspect {
    ...
    @Pointcut("execution(public * sefa.instancesmanager.domain.InstancesManagerService.*(..))")
    public void instancesManagerMethods() {}

    @Pointcut("execution(public void sefa.instancesmanager.domain.InstancesManagerService.*(..))")
