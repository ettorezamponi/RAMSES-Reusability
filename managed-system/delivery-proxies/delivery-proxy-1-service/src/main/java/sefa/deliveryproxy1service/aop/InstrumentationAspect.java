package sefa.deliveryproxy1service.aop;

import sefa.deliveryproxy1service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * sefa.deliveryproxy1service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void sefa.deliveryproxy1service.domain.DeliveryProxyService.*(..))")
