package sefa.deliveryproxy2service.aop;

import sefa.deliveryproxy2service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * sefa.deliveryproxy2service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void sefa.deliveryproxy2service.domain.DeliveryProxyService.*(..))")
