package sefa.deliveryproxy3service.aop;

import sefa.deliveryproxy3service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * sefa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
    public void deliveryProxyServiceMethods() {}

    @Pointcut("execution(public void sefa.deliveryproxy3service.domain.DeliveryProxyService.*(..))")
