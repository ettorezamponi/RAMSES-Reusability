package sefa.restaurantservice.aop;

import sefa.restaurantservice.exceptions.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * sefa.restaurantservice.domain.RestaurantService.*(..))")
    public void restaurantServiceMethods() {}

    @Pointcut("execution(public void sefa.restaurantservice.domain.RestaurantService.*(..))")
