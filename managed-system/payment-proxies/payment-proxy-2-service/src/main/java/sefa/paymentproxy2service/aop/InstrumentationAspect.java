package sefa.paymentproxy2service.aop;

import sefa.paymentproxy2service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * sefa.paymentproxy2service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void sefa.paymentproxy2service.domain.PaymentProxyService.*(..))")
