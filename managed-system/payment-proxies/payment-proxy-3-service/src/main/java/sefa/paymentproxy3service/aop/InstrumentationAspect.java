package sefa.paymentproxy3service.aop;

import sefa.paymentproxy3service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * sefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void sefa.paymentproxy3service.domain.PaymentProxyService.*(..))")
