package sefa.paymentproxy1service.aop;

import sefa.paymentproxy1service.exception.ForcedException;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * sefa.paymentproxy1service.domain.PaymentProxyService.*(..))")
    public void paymentProxyServiceMethods() {}

    @Pointcut("execution(public void sefa.paymentproxy1service.domain.PaymentProxyService.*(..))")
