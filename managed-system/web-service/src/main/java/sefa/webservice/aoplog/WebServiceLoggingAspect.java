package sefa.webservice.aoplog;
...
public class WebServiceLoggingAspect {
    ...
    @Pointcut("execution(public * sefa.webservice.domain.admin.AdminWebService.*(..))")
    public void webServiceMethods() {}

    @Pointcut("execution(public void sefa.webservice.domain.admin.AdminWebService.*(..))")
