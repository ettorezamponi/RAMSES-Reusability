package sefa.restclient.aoplog;
...
public class RestClientLoggingAspect {
    ...
    @Pointcut("execution(public * sefa.restclient.domain.RequestGeneratorService.*(..))")
    public void restClientMethods() {}

    @Pointcut("execution(public void sefa.restclient.domain.RequestGeneratorService.*(..))")
