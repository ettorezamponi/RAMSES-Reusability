package dummymanagedsystem.restclient.aoplog;
...
public class RestClientLoggingAspect {
    ...
    @Pointcut("execution(public * dummymanagedsystem.restclient.domain.RequestGeneratorService.*(..))")
    public void restClientMethods() {}

    @Pointcut("execution(public void dummymanagedsystem.restclient.domain.RequestGeneratorService.*(..))")
