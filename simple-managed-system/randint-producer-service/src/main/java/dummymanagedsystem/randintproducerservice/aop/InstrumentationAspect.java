package dummymanagedsystem.randintproducerservice.aop;
...
public class InstrumentationAspect {
    ...
    @Pointcut("execution(public * dummymanagedsystem.randintproducerservice.domain.RandintProducerService.*(..))")
